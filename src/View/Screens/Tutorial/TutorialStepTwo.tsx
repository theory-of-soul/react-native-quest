...
export class TutorialStepTwo extends AbstractScreenView<S, D, O> {

    public getScreenId() {
        return 'TutorialStepTwo'
    }
    ...
    public mapStateToProperties(state: ApplicationStateType, ownProps: O): S {
        return {
            ...
            showStep: state.initialize.get('tutorialStep', 0) === 1
        };
    }
